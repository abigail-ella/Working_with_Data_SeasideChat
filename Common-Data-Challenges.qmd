...
-   Excluding missing values- (na.omit na.rm)
    ...
    Alternativley, na.rm can be used to ignore missing values during a calculation rather than removing them from the entire data set. This is an argument used within a function rather than a standalone function like na.omit.
